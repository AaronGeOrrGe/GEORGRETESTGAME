...
async function DashboardPage() {
    ...
    const [{ data: resources }, { data: announcements }, { data: favorites }, { data: timetable }, { data: courses }] = await Promise.all([
        supabase.from("resources").select("*").eq("department", profile.department).eq("level", profile.level).order("created_at", {
            ascending: false
        }),
        supabase.from("announcements").select("*").eq("department", profile.department).eq("level", profile.level).order("created_at", {
            ascending: false
        }),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Dashboard"], {
        ...
        initialFavorites: (favorites || []).map((f)=>f.resource_id),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c10599b6._.js.map